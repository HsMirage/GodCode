...
const RedList = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50/20 via-white to-gray-100">
      {/* Header */}
      <div className="bg-gradient-to-r from-green-600 to-emerald-700 text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="text-4xl font-bold mb-4 flex items-center">
            <span className="w-12 h-12 bg-white rounded-lg flex items-center justify-center mr-4">
          ...
          <div className="flex-1">
              ...
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div className="flex items-center space-x-4">
                  ...
                  >
                    ...
                    <option value="severity">贡献最高</option>
                  </select>
                </div>
            ...
            {isLoading ? (
              ...
              <div className="text-center py-16 bg-white rounded-xl border border-gray-200">
                ...
                <h3 className="text-lg font-semibold text-gray-900 mb-2">暂无红榜事件</h3>
