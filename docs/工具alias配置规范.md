...
本文定义 GodCode 中工具别名（alias）的设计与接入规则，确保 Skill 与 Agent 在不同命名风格下稳定执行且不绕过权限。
...
- 工具注册表解析：`/Users/mirage/AI/AiWork/GodCode/src/main/services/tools/tool-registry.ts`
- 执行器解析与审计：`/Users/mirage/AI/AiWork/GodCode/src/main/services/tools/tool-executor.ts`
- 执行服务解析与审计：`/Users/mirage/AI/AiWork/GodCode/src/main/services/tools/tool-execution.service.ts`
- 权限策略归一化：`/Users/mirage/AI/AiWork/GodCode/src/main/services/tools/permission-policy.ts`
- Agent/Category 工具作用域别名映射：`/Users/mirage/AI/AiWork/GodCode/src/main/services/delegate/tool-allowlist.ts`
