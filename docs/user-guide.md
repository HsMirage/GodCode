...
欢迎使用 **GodCode** —— 下一代多 LLM 协同编程平台。本手册将引导您完成安装、配置及日常使用。
...
**A**: GodCode 使用嵌入式 PostgreSQL。如果提示初始化失败，请检查是否有其他程序占用了数据库端口，或尝试以管理员权限重新启动应用。
