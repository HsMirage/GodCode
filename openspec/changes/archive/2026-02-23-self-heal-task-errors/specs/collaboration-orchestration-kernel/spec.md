...
The system SHALL produce a structured integrated result from sub-task outputs rather than plain concatenation, including role-based evidence, handoff trace references, and recovery outcomes.
