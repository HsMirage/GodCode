...
The system SHALL resolve execution route using intent complexity, required capabilities, and binding rules across agent, category, provider, and model, with priority `explicit primary agent selection > category policy > model binding`.
