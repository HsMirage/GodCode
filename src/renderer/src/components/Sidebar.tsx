    ...
    <aside className="fixed inset-y-0 left-0 w-60 border-r border-slate-800/70 bg-slate-950/80 text-slate-100 backdrop-blur">
      <div className="flex h-full flex-col px-4 py-5">
        <div className="flex items-center gap-3 px-2 pb-5">
          <div className="h-9 w-9 rounded-xl border border-slate-800/80 bg-gradient-to-br from-slate-900 via-slate-950 to-black shadow-[0_0_20px_rgba(14,165,233,0.15)] transition-transform duration-500 hover:scale-110" />
          <div>
        ...
        <div className="mb-4 space-y-2">
          <div className="flex items-center justify-between px-2 mb-2">
            ...
            <button
              ...
              className="p-1 rounded-xl hover:bg-slate-800/50 transition-all duration-200"
        ...
        <div className="mt-auto rounded-2xl border border-slate-900/70 bg-gradient-to-br from-slate-950 via-slate-900/70 to-slate-950 px-3 py-4 text-xs text-slate-400 transition-colors duration-300 hover:border-slate-800">
